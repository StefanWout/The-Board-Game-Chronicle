...
| --- | --- | --- |
| forms.py | ![screenshot]![forms py]()
 | Pass: No Errors |
| settings.py | ![screenshot]![settings py]()
 | Pass: No Errors |
| Book views.py | ![screenshot]![views py]()
 | Pass: No Errors |
| Book urls.py| ![screenshot]![urls py]()
 | Pass: No Errors |
|  models.py | ![screenshot]![models py]()
 | Pass: No Errors |
